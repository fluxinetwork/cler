...
<aside class="l-filterList">
	<form id="form-filter-posts" role="form">
		...
		<div class="l-filterList__buttons">
			<a href="<?php echo get_permalink(FORM_EVENT) ?>?act=add" class="c-link c-link--shy"><i class="fa fa-plus c-meta__meta__icon" aria-hidden="true"></i>Poster un événement</a>
