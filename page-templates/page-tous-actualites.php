...
<?php if($public_slug == ''): ?>
	...
	<aside class="l-filterList l-filterList--small">
		<form id="form-auto-filter-posts" role="form" class="l-monoFilter">
			...
			<a href="<?php echo NEWSLETTER_FORM_URL; ?>" class="c-link c-link--shy l-monoFilter__link"><i class="fa fa-envelope c-meta__meta__icon" aria-hidden="true"></i>Abonnement newsletter</a>
		</form>
...
<section class="l-row">
	<div class="l-col l-col--content no-pdTop">
		...
		if ( $query_filtered->have_posts() ) :
			...
			echo '<li><p class="mgTop--s font-subh"><strong>Il n\'y a pas d\'actualités dans cette catégorie pour le moment.</strong></p></li>';
