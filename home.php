...
<section class="l-row bg-light hp-hero">
	<div class="l-col l-hero">
		<div class="hp-hero__content">
			<h1 class="l-hero__title"><span class="u-hide@med">-*- HOME.PHP -*- CLER, </span>Réseau pour la<br class="u-show@small"> transition énergétique</h1>
...
<section class="l-row">
	<div class="l-col">
		...
		<div class="l-grid l-grid--2col grid-actions">
			<div class="l-grid__col">
				<a href="#" class="c-tile c-tile--rectangle c-tile--hover">
					<div class="c-tile__content">
	...
	<div class="l-col l-grid">
		...
		<div class="l-grid__col">
			<div class="l-flexCol l-flex--center">
				...
				<a href="#" class="c-btn c-btn--cta mgTop--l"><span>Ça m'interesse !</span></a>
			</div>	
		</div>
	</div>
</section>
