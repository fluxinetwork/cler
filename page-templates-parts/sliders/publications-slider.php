		...
		<div class="l-card-slider">
			<aside class="l-card-slider__aside">
				...
				<div class="l-card-slider__aside__more l-card-slider__aside__more--follow">
					<a href="<?php echo get_permalink(CONTACT);?>" class="c-meta__meta" target="_blank"><i class="fa fa-envelope c-meta__meta__icon" aria-hidden="true"></i>Besoin d'aide ?</a>
				</div>
			</aside>
			...
			<div class="l-card-slider__cards">
				<ul class="l-card-slider__cards__row">
					...
					<?php
						while ( $query_publications->have_posts() ) :
							...
							if( $post_cpt == 'offres-emploi'):
								$mod_post_url = get_permalink(FORM_OFFRE).'?act=mod&amp;idp='.get_the_ID();
								$cpt_label = 'Offre d\'emploi';
							elseif($post_cpt == 'evenements'):
								$mod_post_url = get_permalink(FORM_EVENT).'?act=mod&amp;idp='.get_the_ID();
								$cpt_label = 'Evénement';
							elseif($post_cpt == 'formations'):
								$mod_post_url = get_permalink(FORM_FORMATION).'?act=mod&amp;idp='.get_the_ID();
								$cpt_label = 'Formation';
							endif;
					...
					?>
						...
						<li id="js-idp-<?php echo get_the_ID(); ?>" class="l-card-slider__cards__row__col">
							...
							<article class="c-card c-card--user">
								...
								<a href="<?php echo get_permalink(get_the_ID()); ?>" class="c-card__bodyLink">
					...
					<li class="l-card-slider__cards__row__col u-show@med">
						<a href="<?php echo get_permalink(FORM_OFFRE); ?>?act=add" class="c-ghostCard">
					...
					<li class="l-card-slider__cards__row__col u-show@med">
						<a href="<?php echo get_permalink(FORM_EVENT); ?>?act=add" class="c-ghostCard">
							<button class="c-btnIcon"><i class="fa fa-plus"></i></button>
					...
					<li class="l-card-slider__cards__row__col u-show@med">
						<a href="<?php echo get_permalink(FORM_FORMATION); ?>?act=add" class="c-ghostCard">
							<button class="c-btnIcon"><i class="fa fa-plus"></i></button>
