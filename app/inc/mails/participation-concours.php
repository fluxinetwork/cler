            ...
            <td style="margin:0;padding:0;">
              <table width="100%" style="text-align:left; margin:20px 0;" border="0" cellpadding="0" cellspacing="0">
                <tr style="margin:0;padding:0;">
                  <td style="background: #fff; padding:20px 30px 30px;">
                    <h3 style="text-align:left; font-family: gotham,helvetica,arial,sans-serif; font-size:20px;line-height: 22px;">Bonjour '.$nom_prenom.'</h3>          
                    <p style="text-align:left; font-family: gotham,helvetica,arial,sans-serif; font-size:16px;line-height: 22px;">Merci pour votre participation au concours de courts-métrages CLER Obscur.<br><br>Nous avons bien reçu votre inscription au concours de courts-métrages CLER Obscur, pour le film "Vive le soleil", et nous vous en remercions.<br><br>Le jury effectuera une pré-selection qui aura lieu du 15 au 20 novembre 2017. Nous vous tiendrons informés par email du résultat de leur délibération. Si votre vidéo est pré-sectionnée, elle sera publiée sur la page du concours, comme le stipule notre règlement.<br><br>Bonne chance!</p>                    
                  </td>
                </tr>
              </table>
              '.$footer_mail.'
